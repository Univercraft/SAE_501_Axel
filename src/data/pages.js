...
export const pages = [
  ...
  { id: 4, type: "pleine-haut", img: `${BASE}assets/page_4.png`, text: "Sur ces entrefaites, le roi passa par le village, sans que personne le reconnût ; et comme il demandait ce qu’il y avait de nouveau, on lui répondit qu’il venait de naître un enfant coiffé, que tout ce qu’il entreprendrait lui réussirait, et qu’on lui avait prédit que, lorsqu’il aurait quatorze ans, il épouserait la fille du roi. Le roi avait un mauvais cœur, et cette prédiction le fâcha. <br> Il alla trouver les parents du nouveau-né, et leur dit d’un air tout amical : « Vous êtes de pauvres gens, donnez-moi votre enfant, j’en aurai bien soin. » <br> Ils refusèrent d’abord ; mais l’étranger leur offrit de l’or, et ils se dirent : « Puisque l’enfant est né coiffé, ce qui arrive est pour son bien. » <br> Ils finirent par consentir et par livrer leur fils. Le roi le mit dans une boîte, et chevaucha avec ce fardeau jusqu’au bord d’une rivière profonde où il le jeta, en pensant qu’il délivrait sa fille d’un galant sur lequel elle ne comptait guère." },
  ...
  // Pages pleines bas
  { id: 5, type: "pleine-bas", img: `${BASE}assets/page_5.png`, text: "Mais la boîte, loin de couler à fond, se mit à flotter comme un petit batelet, sans qu’il entrât dedans une seule goutte d’eau ; elle alla ainsi à la dérive jusqu’à deux lieues de la capitale, et s’arrêta contre l’écluse d’un moulin. Un garcon meunier qui se trouvait là par bonheur l’apercut et l’attira avec un croc ; il s’attendait, en l’ouvrant, à y trouver de grands trésors : mais c’était un joli petit garcon, frais et éveillé. Il le porta au moulin ; le meunier et sa femme, qui n’avaient pas d’enfants, recurent celui-là comme si Dieu le leur eût envoyé." },
  { id: 6, type: "pleine-bas", img: `${BASE}assets/page_6.png`, text: "Ils traitèrent de leur mieux le petit orphelin, qui grandit chez eux en forces et en bonnes qualités." },
  { id: 7, type: "pleine-bas", img: `${BASE}assets/page_7.png`, text: "Un jour, le roi, surpris par la pluie, entra dans le moulin et demanda au meunier si ce grand jeune homme était son fils. « Non, sire, répondit-il : c’est un enfant trouvé qui est venu dans une boîte échouer contre notre écluse, il y a quatorze ans ; notre garcon meunier l’a tiré de l’eau. »" },
  ...
  { id: 8, type: "petite", img: `${BASE}assets/page_8.png`, text: "Le roi reconnut alors que c’était l’enfant né coiffé qu’il avait jeté à la rivière. <br>« Bonnes gens, dit-il, ce jeune homme ne pourrait-il pas porter une lettre de ma part à la reine ? je lui donnerais deux pièces d’or pour sa peine. <br>— Comme Votre Majesté l’ordonnera, » répondirent-ils ; <br> et ils dirent au jeune homme de se tenir prêt. <br> Le roi écrivit à la reine une lettre où il lui mandait de se saisir du messager, de le mettre à mort et de l’enterrer, de facon à ce qu’il trouvât la chose faite à son retour"},
  { id: 9, type: "petite", img: `${BASE}assets/page_9.png`, text: "Le garcon se mit en route avec la lettre, mais il s’égara et arriva le soir dans une grande forêt. Au milieu des ténèbres, il apercut de loin une faible lumière, et, se dirigeant de ce côté, il atteignit une petite maisonnette où il trouva une vieille femme assise près du feu. Elle parut toute surprise de voir le jeune homme et lui dit :<br>« D’où viens-tu et que veux-tu? <br> —Je viens du moulin, répondit-il ; je porte une lettre à la reine ; j’ai perdu mon chemin, et je voudrais bien passer la nuit ici. <br> — Malheureux enfant, répliqua la femme, tu es tombé dans une maison de voleurs, et, s’ils te trouvent ici, c’est fait de toi<br> — A la grâce de Dieu ! dit le jeune homme, je n’ai pas peur ; et, d’ailleurs, je suis si fatigué qu’il m’est impossible d’aller plus loin.<br>Il se coucha sur un banc et s’endormit. " },
